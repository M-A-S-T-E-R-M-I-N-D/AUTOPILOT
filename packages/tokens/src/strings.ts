...
const EN_STRINGS = {
  ...
  pipelineLensFleetTip: 'Nodes represent firing traces, fleet-wide',
  pipelineLensFiles: 'Files',
  pipelineLensFilesTip: 'Nodes represent files touched by gate-passed firings',
  pipelineModeLabel: 'Pipeline node grouping',
  pipelineModeGrouped: 'Grouped',
  pipelineModeGroupedTip: 'One node per trace or file, with a count',
  pipelineModeFlat: 'Flat',
  pipelineModeFlatTip: 'One node per span, in order',
  pipelineLayoutLabel: 'Pipeline canvas layout',
  pipelineLayoutLayered: 'Layered',
  pipelineLayoutLayeredTip: 'One lane per trace on the canvas',
  pipelineLayoutCompact: 'Compact',
  pipelineLayoutCompactTip: 'Related traces share a lane; others pack into a grid',
...
export const STRINGS: Readonly<Record<LocaleName, Readonly<Record<StringKey, string>>>> = {
  ...
  he: {
    ...
    pipelineLensFleetTip: 'הצמתים מייצגים עקבות הפעלה, לאורך כל הצי',
    pipelineLensFiles: 'קבצים',
    pipelineLensFilesTip: 'הצמתים מייצגים קבצים שבהם נגעו הפעלות שעברו את השער',
    pipelineModeLabel: 'קיבוץ צמתי הצנרת',
    pipelineModeGrouped: 'מקובץ',
    pipelineModeGroupedTip: 'צומת אחד לכל עקבה או קובץ, עם ספירה',
    pipelineModeFlat: 'שטוח',
    pipelineModeFlatTip: 'צומת אחד לכל שלב, לפי הסדר',
    pipelineLayoutLabel: 'פריסת קנבס הצנרת',
    pipelineLayoutLayered: 'בשכבות',
    pipelineLayoutLayeredTip: 'נתיב אחד לכל עקבה בקנבס',
    pipelineLayoutCompact: 'קומפקטי',
    pipelineLayoutCompactTip: 'עקבות קשורות חולקות נתיב; האחרות נארזות ברשת',
