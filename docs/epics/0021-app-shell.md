...
| 10 | **RTL & density audit** (operator, 2026-09-12: "sometimes we build right-to-left and it looks strange"): measured in Hebrew at 412/768/1024/1280 on live data. The stylesheet was already all-logical; the defects were user content in the wrong direction (bidi laws:  on titles and inputs, LTR for code/commands/paths), masthead popovers overflowing a phone (a viewport sheet below md), a 13k-px Plan subject (bounded span tree and canvas, editor first), pool rows squeezed in the rail (stacked), and a skip link parked off-screen physically (clipped). Proved by unit laws and a phone e2e in both directions | **shipped** —  |
