...
| --- | --- | --- | --- |
| row | 1 → 8 | 15812 → 43304 | 3927.4 |
| task | 1 → 20 | 20390 → 32951 | 661.1 |
| lane | 1 → 8 | 21294 → 28879 | 1083.6 |
...
**97 standard properties, 2875 declarations,
...
**891 selectors across 738 style rules; max
specificity 1,2,0;
...
| 0,2,0 | 148 | `.gh-issue-result:empty` |
