...
> **ARCHIVED (2026-09-06):** pre-0.14.0 changelog narrative, split out of
> [`../../CHANGELOG.md`](../../CHANGELOG.md) to keep the live changelog from growing
> unbounded — this covers the project's founding through v0.13.0. Kept for history;
> the live changelog is the current record going forward.

# Changelog Archive — AUTOPILOT (pre-0.14.0)
