...
Current version **0.52.0** — see [`CHANGELOG.md`](CHANGELOG.md). Built milestone by milestone;
...
pnpm run mutation       # optional, slow: 107 Stryker mutation-testing runs (nightly in CI as six shards)
...
1337 · REL AZEUS · MΔSTERMIND. (2026). *AUTOPILOT* (Version 0.52.0) [Computer software]. https://github.com/M-A-S-T-E-R-M-I-N-D/AUTOPILOT

**IEEE**

1337 · REL AZEUS · MΔSTERMIND, "AUTOPILOT," Version 0.52.0, 2026. [Online]. Available: https://github.com/M-A-S-T-E-R-M-I-N-D/AUTOPILOT
<!-- HOW-TO-CITE:END -->
