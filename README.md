...
Assisted-by: AUTOPILOT v0.55.0 <https://github.com/M-A-S-T-E-R-M-I-N-D/AUTOPILOT>
Harness: claude-cli
...
Current version **0.55.0** — see [`CHANGELOG.md`](CHANGELOG.md). Built milestone by milestone;
...
pnpm run mutation       # optional, slow: 130 Stryker mutation-testing runs (nightly in CI as six shards)
...
1337 · REL AZEUS · MΔSTERMIND. (2026). *AUTOPILOT* (Version 0.55.0) [Computer software]. https://github.com/M-A-S-T-E-R-M-I-N-D/AUTOPILOT

**IEEE**

1337 · REL AZEUS · MΔSTERMIND, "AUTOPILOT," Version 0.55.0, 2026. [Online]. Available: https://github.com/M-A-S-T-E-R-M-I-N-D/AUTOPILOT
<!-- HOW-TO-CITE:END -->
